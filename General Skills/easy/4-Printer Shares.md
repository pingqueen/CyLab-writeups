...
`نکته: گزینه -v اطلاعات بیشتری نمایش می‌دهد و گزینه -z فقط باز یا بسته بودن پورت را آزمایش می‌کند؛ بدون اینکه وارد ارتباط تعاملی شود.`
...
`نکته: دستور get در smbclient یک فایل راه‌دور را از Share شبکه‌ای روی سیستم محلی دانلود می‌کند.`
