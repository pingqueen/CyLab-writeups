...
550851c0
```
`نکته: Clone یعنی دریافت یک نسخه‌ی کامل از Repository موجود روی یک سرور و ساختن یک نسخه‌ی محلی روی کامپیوتر خودت.`
...
`نکته: Commit یعنی ثبت یک نسخه‌ی مشخص از تغییرات پروژه در تاریخچه‌ی Git. می‌توان Commit را شبیه ذخیره‌ کردن یک نقطه‌ی قابل‌ بازگشت در تاریخچه تصور کرد. هر Commit معمولاً شامل این موارد است:(تغییرات فایل‌ها/نام نویسنده/ایمیل نویسنده/تاریخ و زمان/پیام Commit/شناسه یا Hash/اشاره به Commit قبلی) `


`نکته: Push یعنی ارسال Commitهای محلی از کامپیوتر خودت به Repository روی سرور.`
